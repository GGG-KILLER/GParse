...
{
    public abstract partial class VerboseLexer : IMatcherTreeVisitor<LexResult>
    {
        ...
        public LexResult Visit ( RangeMatcher RangeMatcher )
        {
            ...
            return this.Reader.HasContent && range.ValueIn ( ( UInt32 ) this.Reader.Peek ( ) )
        ...
        {
            SourceLocation start = this.Reader.Location;
            Range range = repeatedMatcher.Range;
