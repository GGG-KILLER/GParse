...
namespace GParse.Verbose.Lexing.Compiler
{
    public class LexTreeCompiler : IMatcherTreeVisitor<Expression>
    {
        ...
        // Compiler state
        private readonly VerboseLexer LexerInst;
        private String Name;
        ...
        public LexTreeCompiler ( VerboseLexer lexer )
        {
        ...
        public Func<SourceCodeReader, VerboseLexer, Token> Compile ( RuleDefinition definition, Func<String, String, Object, TokenType, SourceRange, Token> tokenFactory )
        {
            ...
            this.Lexer = Expression.Parameter ( typeof ( VerboseLexer ), "lexer" );
            ...
            return Expression.Lambda<Func<SourceCodeReader, VerboseLexer, Token>> (
                Expression.Block (
                    typeof ( Token ),
        ...
        public Expression Visit ( RulePlaceholder rulePlaceholder )
        {
            ...
            return Expression.Block (
                ...
                Expression.Assign (
                    tok,
                    ExprUtils.MethodCall<Func<SourceCodeReader, VerboseLexer, Token>, SourceCodeReader, VerboseLexer> (
                        ExprUtils.IndexGet ( ExprUtils.FieldGet<VerboseLexer> ( this.Lexer, "CompiledRules" ),
        ...
        {
            Expression dict = ExprUtils.FieldGet<VerboseLexer> ( this.Lexer, "SaveMemory" );
        ...
        {
            MemberExpression dict = ExprUtils.FieldGet<VerboseLexer> ( this.Lexer, "SaveMemory" );
