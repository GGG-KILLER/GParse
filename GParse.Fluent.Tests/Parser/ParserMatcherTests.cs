...
namespace GParse.Fluent.Tests.Parser
{
    ...
    public class ParserMatcherTests
    {
        ...
        public void IgnoreMatcherTest ( )
        {
            ...
            // There are no failure cases for this ↑
        }
        ...
        public void JoinMatcher ( )
        {
            Test ( new JoinMatcher (
                ...
                {
                    new[] { "ab" }
                }, new[] { "ab" }, Array.Empty<String> ( ) );
            // No real failure cases for this either ↑
        }
        ...
        {
            Test ( matcher, Array.Empty<ASTNode[]> ( ), strings, success, error );
        }
