...
namespace GParse.Parsing.Parselets
{
    ...
    /// <returns></returns>
    public delegate Boolean PrefixNodeFactory<TTokenType, ExpressionNodeT> (
    ...
    public class SingleTokenPrefixOperatorParselet<TTokenType, ExpressionNodeT> : IPrefixParselet<TTokenType, ExpressionNodeT>
        where TTokenType : notnull
    {
        private readonly Int32 precedence;
        private readonly PrefixNodeFactory<TTokenType, ExpressionNodeT> factory;
        ...
        public SingleTokenPrefixOperatorParselet ( Int32 precedence, PrefixNodeFactory<TTokenType, ExpressionNodeT> factory )
        {
            if ( precedence < 1 )
