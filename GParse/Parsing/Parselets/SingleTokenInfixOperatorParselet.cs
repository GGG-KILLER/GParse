...
namespace GParse.Parsing.Parselets
{
    ...
    public class SingleTokenInfixOperatorParselet<TokenTypeT, ExpressionNodeT> : IInfixParselet<TokenTypeT, ExpressionNodeT>
    {
        ...
        public SingleTokenInfixOperatorParselet ( Int32 precedence, Boolean isRightAssociative, NodeFactory factory )
        {
        ...
        /// <param name="diagnosticEmmiter"></param>
        /// <returns></returns>
        public ExpressionNodeT ParseInfix ( IPrattParser<TokenTypeT, ExpressionNodeT> parser, ExpressionNodeT leftHandSide, Token<TokenTypeT> readToken, IProgress<Diagnostic> diagnosticEmmiter ) =>
