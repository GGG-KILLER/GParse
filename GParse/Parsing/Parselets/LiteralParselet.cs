...
namespace GParse.Parsing.Parselets
{
    ...
    public delegate Boolean LiteralNodeFactory<TTokenType, ExpressionNodeT> (
    ...
    /// <typeparam name="TTokenType">The <see cref="Token{TTokenType}.Type"/> type.</typeparam>
    /// <typeparam name="ExpressionNodeT">The base type of expression nodes.</typeparam>
    public class LiteralParselet<TTokenType, ExpressionNodeT> : IPrefixParselet<TTokenType, ExpressionNodeT>
        where TTokenType : notnull
    {
        private readonly LiteralNodeFactory<TTokenType, ExpressionNodeT> factory;

        /// <summary>
        /// Initializes a new literal parselet.
        /// </summary>
        /// <param name="factory">The function that transforms a token into an expression node.</param>
        public LiteralParselet ( LiteralNodeFactory<TTokenType, ExpressionNodeT> factory )
        {
