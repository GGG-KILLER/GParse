...
namespace GParse.Parsing.Abstractions.Lexing
{
    ...
    public interface ITokenReader<TokenTypeT> : IEnumerable<Token<TokenTypeT>> where TokenTypeT : Enum
    {
        ...
        /// <param name="token"></param>
        /// <returns></returns>
        Boolean Accept ( IEnumerable<String> IDs, IEnumerable<TokenTypeT> types, out Token<TokenTypeT> token );
        ...
        /// <param name="types"></param>
        /// <returns></returns>
        Boolean Accept ( IEnumerable<String> IDs, IEnumerable<TokenTypeT> types );
        ...
        /// <param name="types"></param>
        /// <returns></returns>
        Token<TokenTypeT> Expect ( IEnumerable<String> IDs, IEnumerable<TokenTypeT> types );
